    ...
    <div class="row">
      <div class="col-md-12">
        <nav class="navbar navbar-default">
          ...
          <h2 class="text-center">Сегодня <?php echo $day;?> день</h2><h4 class="text-center status"></h4><h4 class="text-center timer"></h4>
        ...
        <nav class="navbar navbar-default">
          ...
          <div class="col-md-6 col-xs-12">
            <div class="col-md-3 col-xs-6 relay">
              <input type="checkbox" class="relay1" unchecked name="r1" /> <p> Насос полива</p>
            </div>
            <div class="col-md-3 col-xs-6 relay">
              <input type="checkbox" class="relay2" checked name="r2" /> <p> Реле 2</p>
            </div>
            <div class="col-md-3 col-xs-6 relay">
              <input type="checkbox" class="relay3" unchecked name="r3" /> <p> Реле 3</p>
            </div>
            <div class="col-md-3 col-xs-6 relay">
              <input type="checkbox" class="relay4" unchecked name="r4" /> <p> Реле 4</p>
            </div>
          </div>
          <div class="col-md-3 hidden-xs"><h3 class="text-center">Relays</h3>
          </div>
