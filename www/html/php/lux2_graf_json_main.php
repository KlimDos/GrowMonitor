...
$query = $mysqli->query('select * from luminosity ORDER BY date DESC LIMIT 450');
$table = array();
$table['cols'] = array(
...
while($r = mysqli_fetch_assoc($query)) {
	...
	$temp[] = array('v' => floatval($r['lux2'])); // typecast all numbers to the appropriate type (int or float) as needed - otherwise they are input as strings
